...
test_that("DESeq2 overlaps", {
  ...
  expect_equal(dim(overlapped_results[['results_tables']][['unprocessed']]), c(524, 9))
  expect_equal(dim(overlapped_results[['results_tables']][['mutant_response']]), c(162, 13))
  expect_equal(dim(overlapped_results[['results_tables']][['delay']]), c(74, 13))
  expect_equal(dim(overlapped_results[['results_tables']][['no_delay']]), c(172, 13))
  expect_equal(dim(overlapped_results[['results_tables']][['discard']]), c(235, 13))
  expect_equal(dim(overlapped_results[['results_tables']][['all_genes']]), c(1999, 13))
})
